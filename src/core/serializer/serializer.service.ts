...
export class SerializerService {
    ...
    constructor(private readonly entityResourceMapper: EntityResourceMapperService) {}
    ...
    getResource(entity: BaseEntity | BaseEntity[]): BaseResource | BaseResource[] {
        ...
        return transformAndValidateSync(resourceType, entity, {validator: {whitelist: true}})
    }
