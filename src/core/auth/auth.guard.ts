...
import { UnauthorizedException, Guard, CanActivate, ExecutionContext } from "@nestjs/common";
...
export class AuthGuard implements CanActivate {
    ...
    canActivate(request: Request, context: ExecutionContext): boolean | Promise<boolean> | Observable<boolean> {
